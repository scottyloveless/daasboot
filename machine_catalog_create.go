...
func (cfg *config) createMachineCatalog() (MachineCatalogGetInfo, error) {
	...
	body.ProvisioningScheme.MachineAccountCreationRules.NamingScheme = "MC-##"
	body.ProvisioningScheme.MachineAccountCreationRules.NamingSchemeType = "Alphabet"
	body.RemotePCEnrollmentScopes[0].Ou = "vet.svp.internal"
